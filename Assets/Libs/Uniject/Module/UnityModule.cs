...
public class UnityModule : NinjectModule {
    ...
    public override void Load() {
		...
		Bind<ICharacterController> ().To<UnityCharacterController> ().InScope(Scoping.GameObjectBoundaryScoper);
		Bind<ICamera> ().To<UnityCamera> ();
		Bind<IAnimator> ().To<UnityAnimator> ().InScope (Scoping.GameObjectBoundaryScoper);
        ...
        Bind<ICharacterInput>().To<CharacterKeyboardInput>().InSingletonScope();
#else        
        Bind<ICharacterInput>().To<CharacterMobileInput>().InSingletonScope();
#endif   

...
namespace Uniject {
    ...
    public abstract class TestableGameObject {
		...
		{
			for (int t = 0; t < components.Count; t++) {
				components[t].OnMouseDown();
			}
		}

		public abstract void StartCoroutine (System.Collections.IEnumerator coroutine);
		...
		internal abstract void AddInvokeRepeatable (IInvokeRepeatable repeatable);
		internal abstract bool RemoveInvokeRepeatable (IInvokeRepeatable repeatable);

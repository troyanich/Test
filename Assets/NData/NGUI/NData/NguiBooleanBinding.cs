...
{
	private Dictionary<Type, EZData.Property> _properties = new Dictionary<Type, EZData.Property>();
	...
	protected override void OnChange()
	{
		...
		else
		{
			var val = 0.0;
			if (_properties [typeof(string)] != null) {
				var valStr = ((EZData.Property<string>)_properties [typeof(string)]).GetValue ();

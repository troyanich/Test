...
public class UILabelInspector : UIWidgetInspector
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
            ...
            NGUIEditorTools.DrawProperty("Sheet", serializedObject, "localizeSheetTitle",  GUILayout.MinWidth(160f));
            NGUIEditorTools.SetLabelWidth(35f);
            NGUIEditorTools.DrawProperty("Key", serializedObject, "localizeKey", GUILayout.MinWidth(250f));
            GUILayout.Space(4f);

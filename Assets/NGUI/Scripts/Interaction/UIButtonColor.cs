...
public class UIButtonColor : UIWidgetContainer
{
	...
	protected void OnPointerDown (UnityEngine.EventSystems.BaseEventData eventData)
	{
		TweenColor.Begin(tweenTarget, duration, pressed);
	}

	protected void OnPointerUp (UnityEngine.EventSystems.BaseEventData eventData)
	{
		TweenColor.Begin(tweenTarget, duration, mColor);
	}
}

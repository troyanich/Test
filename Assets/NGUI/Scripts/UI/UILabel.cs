...
public class UILabel : UIWidget
{
    ...
    [HideInInspector][SerializeField] string localizeKey = "";
    [HideInInspector][SerializeField] string localizeSheetTitle = "";
	...
	protected override void OnStart ()
	{
        ...
        if(!string.IsNullOrEmpty(localizeKey))
	        text = Language.Get(localizeKey, localizeSheetTitle);
	}
